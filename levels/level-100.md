...
2. For each episode, _at least_ following must be displayed:
   1. The name of the episode [x]
   2. The season number [x]
   3. The episode number [x]
   4. The medium-sized image for the episode [x]
   5. The summary text of the episode [x]
3. Combine season number and episode number into an **episode code**:
   1. Each part should be zero-padded to two digits. [x]
   2. Example: `S02E07` would be the code for the 7th episode of the 2nd season. `S2E7` would be incorrect. [x]
